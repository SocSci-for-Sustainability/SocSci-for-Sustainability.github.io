...
*Social Science for Sustainability by Matt Turner* is the product of an
interdisciplinary social, computational, and cognitive science being tapped to 
teach a series of courses that introduce *sustainability students* to quantitative, rigorous
social science. 

I emphasize that it is by me, *Matt Turner*, because I want this to be
anti-colonial. I want you to be inspired to create your own *Social Science
...
problem-focused social science. He is a Lecturer in Environmental Social
...
This work flows from an underlying theme and drive: a consilient curation of
social science and, indeed, all knowledge. Curation is a type of consolidation.
...
For example, quantum
mechanics consolidates research on the spectrum of hydrogen atoms, the periodic
table, and related atomic and molecular science research that predated its
development. 

When we consolidtate theories, we get a benefit of fewer ideas we have to keep in working
memory to think about the systems of interest. But there's an added benefit that
we see unpredictably useful and aesthetically beautiful connections between 
what seemed to be disconnected phenomena. This bonus is evidence of
*consilience*, where the whole of a consilient theory is more than just the sum
of its parts.
